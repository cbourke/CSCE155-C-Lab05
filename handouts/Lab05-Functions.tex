...
Compile the imageDrive file using 
    
\mintinline{text}{gcc -lm -std=c99 -o imageDriver imageDriver.c imageUtils.c colorUtils.c}
    
Then run the program with 
    
\mintinline{text}{./imageDriver huskers.png output.png 1}
    
Take a look at the file created in your lab directory called output.png. You can experiment with other modes (the integer at the end of the command. Accepts values 1-4), or even with your own images.

\section{Advanced Activity (Optional)}

\begin{enumerate}
    \item Write a few more functions in the \mintinline{c}{orderStatistics.c} program.  First,
